...
public class HandsResultImageView extends AppCompatImageView {
    ...
    private void drawLandmarksOnCanvas(
        ...
        landmarkPaint.setColor(Color.BLACK);
        landmarkPaint.setTextSize(50);
        canvas.drawText(""+tipDepth+"(mm)",tip.x,tip.y, landmarkPaint);
    }
}
